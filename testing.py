...
if __name__ == "__main__":
    ...
    reader = brainocr.Reader(
        ...
        rec_model_ckpt_fp="/workspace/SKKUOCR2/SKKUOCR_fine/assets/test_17/finetune_clova.pt",
        opt_fp="/workspace/SKKUOCR2/SKKUOCR_fine/assets/test_17/finetune_clova_opt.txt",
        device="cuda",
    )
